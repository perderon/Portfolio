...
<h2 class="main-content">Покупатели</h2>
<body>
    <table>
        <tr>
            <th>Номер</th>
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                    <a href='edit_customer.php?idcustomer=" . $row["idcustomer"] . "' class='btn btn-info btn-sm'><i class='fa fa-pencil'></i> Изменить</a>
                  <a href='delete_customer.php?idcustomer=" . $row["idcustomer"] . "' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i> Удалить</a>
                </td>";
                    echo "</tr>";
                }
            } else {
