...
<h2 class="main-content">Изменить покупателей</h2>
<body>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE customer SET FN='$FN', SN='$SN', DN='$DN', BD='$BD', passport='$passport' WHERE idcustomer='$idcustomer'";

            if (mysqli_query($conn, $sql)) {
                echo "Изменение прошло успешно";
            } else {
                echo "Ошибка изменения: " . mysqli_error($conn);
            }
        }
