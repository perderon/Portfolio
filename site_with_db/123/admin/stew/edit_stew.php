...
<h2 class="main-content">Изменить стюардессы</h2>
<body>
    <?php
        ...
        if (isset($_GET['idstew'])) {
            $idstew = $_GET['idstew'];
            $sql = "SELECT * FROM stewardess WHERE idstew='$idstew'";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE stewardess SET FN='$FN', SN='$SN', DN='$DN', BD='$BD', passport='$passport' WHERE idstew='$idstew'";
